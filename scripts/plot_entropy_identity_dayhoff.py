...
MIN_IDENTITY = 30.0
MAX_IDENTITY = 85.0
FASTA_PATH = "data/decoded_embeddiff_dayhoff.fasta"
...
plt.tight_layout()
plt.savefig("figures/fig5c_entropy_scatter_dayhoff.png", dpi=300)
plt.close()

print("✅ Entropy vs Identity plot saved for Dayhoff embeddings.")
