...
GEN_EMB = "embeddings/decoded_embeddings.npy"
OUT_DIR = "figures"
...
def main():
    ...
    plot_heatmap(rr_sim, "Natural Sequences", "Natural Sequences", "fig5a_real_real_cosine.png")
    plot_mds(rr_sim, real_labels, "", "fig5a_real_real_mds.png")

    gg_sim = cosine_similarity(gen_emb)
    plot_heatmap(gg_sim, "Generated Sequences", "Generated Sequences", "fig5b_gen_gen_cosine.png")
    plot_mds(gg_sim, gen_labels, "", "fig5b_gen_gen_mds.png")

    rg_sim = cosine_similarity(real_emb, gen_emb)
    plot_heatmap(rg_sim, "Generated Sequences", "Natural Sequences", "fig5c_real_gen_cosine.png")
    print("✅ All publication-quality figures saved to:", OUT_DIR)

    plot_cosine_histograms(
    sim_matrices=[rr_sim, gg_sim, rg_sim],
    labels=["Natural–Natural", "Gen–Gen", "Natural–Gen"],
    title="",
    filename="fig5d_all_histograms.png"
)
