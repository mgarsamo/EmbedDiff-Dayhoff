# scripts/sample_embeddings_dayhoff.py
...
EMBEDDING_PATH = os.path.join(ROOT, "embeddings", "dayhoff_embeddings.npy")
FASTA_PATH = os.path.join(ROOT, "data", "curated_thioredoxin_reductase.fasta")
OUTPUT_PATH = os.path.join(ROOT, "embeddings", "sampled_dayhoff_embeddings.npy")
FIGURE_PATH = os.path.join(ROOT, "figures", "fig3a_generated_tsne_dayhoff")
TSNE_COORDS_PATH = os.path.join(ROOT, "embeddings", "tsne_coords_dayhoff.npy")
TSNE_LABELS_PATH = os.path.join(ROOT, "embeddings", "tsne_labels_dayhoff.npy")
...
print(f"🎯 Sampling {num_samples} Dayhoff embeddings with mild noise (std={noise_std})...")
...
print(f"✅ Saved noisy Dayhoff embeddings to: {OUTPUT_PATH}")
...
print(f"✅ Saved Dayhoff t-SNE coordinates to: {TSNE_COORDS_PATH}")
print(f"✅ Saved Dayhoff t-SNE labels to: {TSNE_LABELS_PATH}")
...
print("✅ Dayhoff t-SNE plot saved.")
