...
BLAST_META = "data/decoded_embeddiff.fasta"
OUT_DIR = "figures"
...
plt.legend(handles=handles, title="Domain", title_fontsize=13, fontsize=12, frameon=True)


# === Save ===
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "fig5f_tsne_domain_overlay.png"), dpi=300)
plt.close()
