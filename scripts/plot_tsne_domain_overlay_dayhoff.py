# scripts/plot_tsne_domain_overlay_dayhoff.py
...
BLAST_META = "data/decoded_embeddiff_dayhoff.fasta"
OUT_DIR = "figures"
...
plt.legend(handles=handles, title="Domain (Dayhoff)", title_fontsize=13, fontsize=12, frameon=True)

# === Save ===
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, "fig5f_tsne_domain_overlay_dayhoff.png"), dpi=300)
plt.savefig(os.path.join(OUT_DIR, "fig5f_tsne_domain_overlay_dayhoff.svg"))
plt.close()

print("✅ Dayhoff t-SNE domain overlay saved.")
