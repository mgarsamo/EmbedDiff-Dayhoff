...
# Manually set the legend title to bold
legend.get_title().set_fontweight('bold')

# === Save ===
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "fig_tsne_by_domain.png"), dpi=300)
plt.savefig(os.path.join(output_dir, "fig_tsne_by_domain.svg"))
plt.close()
