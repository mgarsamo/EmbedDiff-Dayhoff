...
# === Config ===
fasta_file = "data/decoded_embeddiff_dayhoff.fasta"
output_dir = "data/blast_results"
csv_output = os.path.join(output_dir, "blast_summary_local_dayhoff.csv")
...
for i, seq_record in enumerate(sequences):
    ...
    print(f"\n🔬 [Dayhoff] BLASTing sequence {i+1}/{len(sequences)}: {seq_record.id}")
...
print(f"\n✅ Done! [Dayhoff] Sorted BLAST results saved to:\n{csv_output}")
