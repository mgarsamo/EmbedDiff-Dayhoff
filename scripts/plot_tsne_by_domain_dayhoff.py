...
# scripts/plot_tsne_by_domain_dayhoff.py
...
# === Paths ===
embedding_path = "embeddings/dayhoff_embeddings.npy"
...
legend = ax.legend(
    title="Thioredoxin Reductase (Dayhoff)",
    title_fontsize=14,
    prop=font_props,
    frameon=True,
    edgecolor="black",
...
# === Save ===
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "fig_tsne_by_domain_dayhoff.png"), dpi=300)
plt.savefig(os.path.join(output_dir, "fig_tsne_by_domain_dayhoff.svg"))
plt.close()

print("✅ Saved Dayhoff t-SNE plot to figures/")
